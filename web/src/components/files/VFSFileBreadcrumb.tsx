...
export function VFSFileBreadcrumb() {
  const { currentVirtualPath, navigateVirtualTo } = useFileStore()
      ...
      {parts.map((part, index) => {
        ...
        return (
          <div key={path} className="flex items-center gap-1 shrink-0">
            ...
            <button
              onClick={() => !isLast && navigateVirtualTo(path)}
