...
export const sourceApi = {
  ...
  create: (data: CreateSourceRequest) => apiClient.post<StorageSource>('/sources', data),
  update: (id: number, data: UpdateSourceRequest) => apiClient.patch<StorageSource>(`/sources/${id}`, data),
